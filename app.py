...
from scripts.job_manager import job_manager_loop
...
from apps.emails.utils import send_verification_email, send_admin_notification, send_email, send_activation_email, send_processing_complete_email
...
from apps.autentication import aut_bp
app.register_blueprint(aut_bp)

from apps.emails import emails_bp
app.register_blueprint(emails_bp)

from apps.logs import logs_bp
app.register_blueprint(logs_bp)

from apps.alphafold import apf_bp
app.register_blueprint(apf_bp)

from apps.admin_rotas import admins_bp
app.register_blueprint(admins_bp)

from apps.users_rotas import users_bp
